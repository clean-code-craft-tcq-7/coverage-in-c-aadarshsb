...
- Enter Reflections: Replace the `enter_` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
**1.Limit code complexity, 2. avoid duplication to optimize code size, 3. Whenever posssible write modular code to subtitute the modules in future, if required. 4. Avoid #defines and used const, whereever possible to better debug, 5.Cover all the boundary conditions. 6.Avoid Godclass and apply SRP principle in code**
